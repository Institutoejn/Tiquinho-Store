...
const Logo = ({ className = "w-10 h-10" }: { className?: string }) => (
  <img 
    src="https://i.imgur.com/J5Q6lIB.png" 
    alt="Tiquinho Corporate" 
...
export default function App() {
  ...
  useEffect(() => {
    const initAuth = async () => {
      ...
      if (session) {
        // CORREÇÃO CRÍTICA: Lendo de 'profiles' em vez de 'users' para compatibilidade com SQL Policy
  ...
  const fetchOrders = async () => {
      ...
      if (orderData) {
          // Check for status changes (basic implementation)
  ...
  const handleFinalize = async () => {
      ...
      fetchOrders(); // Immediate fetch to update local list if viewing history
  };
        ...
        <div className="w-full max-w-md">
            {authFlow === 'initial' ? (
                <div className="flex flex-col items-center gap-6">
                    <img src="https://i.imgur.com/J5Q6lIB.png" className="w-32 h-32 object-contain mb-4 drop-shadow-2xl" alt="Logo Tiquinho"/>
